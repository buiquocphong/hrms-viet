...
class CreateEmployeeTypesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Employee_types", 'employee_types', 'loai_nhan_vien', 'fa-cube', [
            ["loai_nhan_vien", "Loại Nhân Viên", "Name", true, "Nhân Viên", 1, 100, true],
            ["loai_nhan_vien_en", "Loại N.Viên (T.Anh)", "Name", false, "", 0, 256, false],
        ]);
