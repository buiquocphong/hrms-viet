			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'ma_chuc_vu')
						@la_display($module, 'chuc_vu_vi')
						@la_display($module, 'chuc_vu_en')
						@la_display($module, 'tinh_tang_ca')
						@la_display($module, 'cham_gio_cong')
					</div>
				</div>
			</div>
		</div>
